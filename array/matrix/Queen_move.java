 ...
 *  The Queen cannot pass through obstacles. 
 *  Given the position (x, y) of Queen, the task is to 
 *  find the number of cells the queen can move.
 */
public class Queen_move {
	...
	static class pair
	  ...
	  public static void main(String[] args)
	  {
	    ...
	    System.out.print(numberofPosition(n, k, Qposx, Qposy, obstPosx, obstPosy) +"\n");
	  }
}
